...
def build_candidate_generation_prompt(
    ...
    user_prompt = (
        ...
        "- action_id values must be unique within the pack.\n"
        ...
        "- Use canonical response-profile ids exactly as listed below. Do not invent aliases, translations, or new ids.\n"
        ...
        "- Do not use input_mode=structured_fields for generated actions. The current review and execution flow does not support generated per-field input collection.\n"
        "- Prefer input_mode=single_text. Use text_with_instruction only when the action clearly needs an extra instruction channel.\n"
        ...
        "- Each action should produce a distinct end-user outcome, not a renamed variation of the same planning step.\n"
        ...
        "- Do not create actions whose main output is a workflow plan, research brief, strategy outline, or meta prompt unless the goal explicitly asks for that artifact.\n"
